function [Exg_rate_in_system_check,Exg_rate_disposed_system_check,exergy_sources_table, exergy_disposition_table]=...
    ...
    Exg_rate_in_system_check = Exg_f_rate_in_fan+Exg_w_rate_in_fan+Exg_q_rate_in_heatingwhole+Exg_q_rate_in_hp_free;
    sources_exergy = {
        ...
        'Exergy of Heat Through HP', Exg_q_rate_in_hp_free, 'W',Exg_q_rate_in_hp_free/m_dot, 'kJ/kg';
    ...
    Exg_rate_disposed_system_check = Exg_q_rate_out_hospital+Exg_q_rate_loss_furnace+Exg_q_rate_loss_he+...
        Exg_f_rate_out_regHE + Exg_d_rate_fan+ Exg_d_rate_heatingwhole+Exg_d_rate_hospital;
    disposition_exergy = {
        ...
        'Exergy of Heat Loss by HE', Exg_q_rate_loss_he, 'W', Exg_q_rate_loss_he/m_dot, 'kJ/kg';
        'Exergy of Flow Out from Hospital (at exit of  RegHE)', Exg_f_rate_out_regHE, 'W', Exg_f_rate_out_regHE/m_dot, 'kJ/kg';
