function [Cost_Table, Carbon_Emissions_Table_winter, plotData]=Option4(T0_list_input,P0_input,T_design_input,P_design_input,T_discharge_input,P_disccharge_input)
...
for tt= 1:length(T0_list)
   ...
   %% For GUI Error
    if T4 <= T2
        error('Discharge Temperature T4 (at the exit of Hospital) is less than or equal to T3 (Design Temperature).');
    end
