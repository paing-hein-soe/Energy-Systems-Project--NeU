function [State_Table, states, Specific_Energy, Carried_Energy_Rate, Specific_Flow_Exergy, Flow_Exergy_Rate] = States_Option3_Fn(m_dot,cp,R,T0, T1, T2, T2B, T3, T4, P0, P1, P2, P2B, P3, P4)
...
State_Label = {states{1}.label; states{2}.label; states{3}.label; states{4}.label; states{5}.label};
Description = {'Fan Inlet'; 'Fan Outlet';'2B (Bet. heating by HE and HP)'; 'Heating by Furnace- Outlet'; 'Hospital Discharge'};
Temperature_K = [states{1}.T; states{2}.T; states{3}.T; states{4}.T;states{5}.T;];
Pressure_Pa = [states{1}.P; states{2}.P; states{3}.P; states{4}.P; states{5}.T;];
